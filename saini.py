...
async def download_video(url,cmd, name):
    download_cmd = (f'{cmd} --no-part --fragment-retries 50 --downloader aria2c ''--downloader-args "aria2c: -x 32 -j 64 -k 2M --max-connection-per-server=16 --file-allocation=none"')
