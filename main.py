...
photologo = 'https://tinypic.host/images/2025/07/24/2generated-image.png' #https://envs.sh/GV0.jpg
photoyt = 'https://tinypic.host/images/2025/07/24/2generated-image.png' #https://envs.sh/GVi.jpg
photocp = 'https://tinypic.host/images/2025/07/24/2generated-image.png'
photozip = 'https://tinypic.host/images/2025/07/24/2generated-image.png'
...
image_urls = [
    "https://tinypic.host/images/2025/07/24/2generated-image.png",
    "https://tinypic.host/images/2025/07/24/2generated-image.png",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://tinypic.host/images/2025/07/24/2generated-image.png",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/KINGSTONJK7")],
        ])
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://tinypic.host/images/2025/07/24/2generated-image.png",
        caption=caption
      ),
